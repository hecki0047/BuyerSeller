...
@section('page_css')
<link property='stylesheet' href="{!! asset('css/border-protection.css',is_secured()) !!}" rel="stylesheet">
<link property='stylesheet' href="{!! asset('assets/fontend/css/select2.min.css',is_secured()) !!}" rel="stylesheet">
@endsection
@section('content')
<style type="text/css">
   .remove_img {
...
<div class="row">
   <div class="col-sm-12 col-md-12 col-lg-12">
      <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="{{URL::to('ServiceChannel/pages/for_new_user',38,is_secured())}}" class="top-path-li-a"><span itemprop="name">For Buyers</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
...
<div class="row padding_0" style="background-color: #fff; padding-bottom: 5%; margin-bottom: 20px;">
   ...
   <div class="col-sm-12 col-md-12">
      <div class="trade-buy-box">
         <h3 class="td-hed"><img itemprop="image" style="height:30px;" src="{!! asset('assets/gold/Buyer-protect.jpg',is_secured()) !!}" alt="buyer protect"> Buyer Protection - Get Full Protection for Your Order. <span style="font-size: 13px;padding-left:4%;font-weight: normal;cursor: pointer;"><a href="{{URL::to('BuyerChannel/pages/trade_assurance',5,is_secured())}}">Learn More ></a></span> <i class="fa fa-times" aria-hidden="true" id="trade-close" style=" font-size: 24px !important;font-weight: normal;color: #CCC;float: right;display: block; cursor: pointer;line-height: 24px;"></i></h3>
         <ul style="padding:0;">
            ...
            <li>
               <p style="margin-top: 4%;"><a href="{{URL::to('BuyerChannel/pages/trade_assurance',5,is_secured())}}" style="padding-left: 16px; color: #1686CC; padding-left: 5%; padding-top: 10px;">Buyer Protection ></a></p>
            </li>
         </ul>
      </div>
   ...
   <div class="col-sm-12 col-md-12">
      ...
      <div class="member-email-box">
         ...
         <a class="btn btn-default btn-sm" style="margin-top:4%;display:none;" href="{{URL::to('order-protect',null,is_secured())}}" id="change_email">Change</a>
      </div>
   </div>
   <div class="col-sm-12 col-md-12">
