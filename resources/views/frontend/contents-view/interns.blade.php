@extends('frontend.layouts.master-register')
	...
	<link property='stylesheet' href="{!! asset('assets/fontend/bdtdccss/bdtdc-sme-center-style.css',is_secured()) !!}" rel="stylesheet">
	@endsection
	@section('content')
	...
	<div class="row">
		...
		<div class="col-sm-12">
				<img class="img-responsive" src="{!!asset('assets/images/WOMAN.png',is_secured())!!}">
		</div>
		<diV class="col-sm-12 padding_0" style="padding-top:20px; background-color: #fff; padding-bottom: 3%;">
			<div class="col-sm-2">
				...
				<div class="list-group">
				 <a href="{{ URL::to('web-developer/laravel') }}"> <button type="button" class="list-group-item" style="font-size: 100%;color: #000;font-weight:bold;">Web Developer (php laravel & Vue JS)</button></a>
				...
				<a href="{{ URL::to('about-us',null,is_secured())}}"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;">About Bdtdc</p></a>
				<a href="{{ URL::to('about-us',null,is_secured())}}"><p style="background:#BBB;font-size:18px;padding-left: 7px;color:#fff!important;font-weight: bold;margin-top: -8px;">Contact Us</p></a>
			</div>
			<div class="col-sm-7">
...
</p>			<p class="portal-content-p"><span style="color:#000; font-size: 14px; font-weight: 900;">Positions: Interns</span> can lead to Full Time for the followings positions, work locally at our Mirpur DOHS office, or globally to our Singapore, Vancouver, Canada and Miami, USA.</p>
<ul>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Marketing Executives</span></li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Admin and HR</span></li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Developers:</span> Front End/Back End > php, js, css, laravel, html, vue.js.</li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Engineers:</span> Quality Assurance engineer/analyst</li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">UX/UI:</span> Designers and Developers</li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Online marketing Expert:</span> SEO, Bloggers, Content writers, Youtube, FB experts.</li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Graphic Designers:</span> Adobe photoshop, Illustrator, InDesign.</li>
	<li><span style="color:#000; font-size: 15px; font-weight: 900;">Trade show Hostess:</span> International Convention City Bashundhara (ICCB) and  Bangabandhu International Conference Center.</li>
</ul>
<h3>BuyerSeller.Asia Mission</h3>
<p class="portal-content-p">
   Connecting Global Buyers with Bangladeshi Suppliers representing Made-InBangladesh. The BuyerSeller.Asia is a leading, eco-minded B2B marketplace and a primary facilitator of trade within Greater Bangladesh and South Asia. Our aim is to explore new markets and create global business opportunities for Bangladesh SMEs.  <br><br>
To achieve our mission, we need to create a workforce that represents the rich diversity of our customers. The BuyerSeller.Asia Undergrad Internship Program is a tool to do just that. Our mission, “To unlock everyone’s inner’s talent so they can achieve more”.  
<br><br>
Developing great companies takes many talented individuals to fill several roles throughout the company. The BuyerSeller.Asia Undergrad Internship Program is focused on sourcing and developing talent for careers in Computing, Engineering, Marketing, Administrative and HR, Social Media and Designs.  <br><br>

We are seeking candidates who are passionate about online businesses and offer diverse perspectives. We don’t just value differences, we seek them out. We invite them in. We are a family of individuals at a truly global company, united by a single mission.  
<br><br>
The program is a 12-week internship program specifically designed for college upperclassmen (upcoming seniors and recent graduates) and offers the opportunity to work in one of our BuyerSeller.Asia worldwide.
</p>
