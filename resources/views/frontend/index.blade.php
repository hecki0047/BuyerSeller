@extends('frontend.layouts.home-page.master-home') @section('page_css')
<link property='stylesheet' href="{!! asset('assets/frontend/css/home-page.css') !!}" rel="stylesheet">
<link property='stylesheet' href="{!! asset('assets/frontend/css/home-page-style.css') !!}" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="{{asset('assets/frontend/css/media-query.css')}}">
@endsection @section('content')
 @include('frontend.layouts.home-page.home-slider')
 @include('frontend.layouts.home-page.sidebar-home')
<br>
<br>
<section>
<div class="container">
...
<a target="_blank" itemprop="url" itemprop="url" title="Gold Suppliers: pre-qualified suppliers" href="{{ URL::to('Gold-supplier',null)}}" class="gs"><img class="lazyload" itemprop="image" style="border:none" data-original="{{ asset('assets/frontend/images/Gold-membership.png') }}" alt="Gold membership for Buyer Seller"><span itemprop="name" style="display:none">verified-supplier</span></a>
<a target="_blank" itemprop="url" itemprop="url" href="{{ URL::to('SupplierChannel/pages/verified_supplier',32)}}" title="Verified supplier assessed by a world-leading inspection company (i.e SGS, Bureau Veritas). Click logo to learn more" class="gs"><img class="lazyload" itemprop="image" style="border:none" data-original="{{ asset('assets/frontend/images/verified-supplier.png') }}"></a>
<a target="_blank" itemprop="url" title="Buyer Protection: Ensures on-time shipment and pre-shipment product quality" href="{{ URL::to('BuyerChannel/pages/trade_assurance',5)}}" class="gs"><img class="lazyload" itemprop="image" style="border:none" data-original="{{ asset('assets/frontend/images/Buyer-protection-home.png') }}"><span itemprop="name" style="display:none">verified-supplier</span></a>
<a target="_blank" itemprop="url" itemprop="url" href="{{ URL::to('selected-suppliers/bangladesh-products',18)}}" title="Selected Suppliers: Bangladeshi selected suppliers" class="gs hidden-sm"><img class="lazyload" itemprop="image" style="margin-bottom:8px;border:none" data-original="{{ asset('assets/frontend/images/butterfly-bd.jpg') }}"><span itemprop="name" style="display:none">verified-supplier</span></a>
</div>
...
<div style="position:absolute;display:block;background:url('assets/frontend/images/slider/loading.gif') no-repeat center center;top:0;left:0;width:100%;height:100%"></div>
</div>
...
<img style="border:0;box-shadow:none;height:229px" itemprop="image" data-u="image" height="229" title="{{ $p_name }}" class="lazyload" data-original="{{ asset('assets/frontend/images/products/'.$product->images) }}" alt="{{ $p_name }}"> @else @if($product->bdtdcProduct) @if($product->bdtdcProduct->product_image_new)
...
<img itemprop="image" style="width:42px;height:26px" class="lazyload" data-original="{{ asset('assets/frontend/images/flags/'.strtolower($data->iso_code_2).'.png',null)}}" alt="{{ $data->name }}" /> {{ $data->name }}
</a>
</li>
@endforeach
</ul>
...
<img itemprop="image" style="height:44px;width:44px" class="lazyload" data-original="{{ asset('assets/frontend/images/BD-Source.png') }}" alt="bdsource"> <span class="title" style="position:relative;top:4px">BdSource
</span>
</a>
...
<div class="single-products">
<div class="productinfo text-center" itemscope itemtype="http://schema.org/Product">
@php $p_name = "Product Name Not Available" @endphp
 @if($s->bdtdc_product) @if($s->bdtdc_product->product_name) @php $p_name = $s->bdtdc_product->product_name->name @endphp @endif @elseif(trim($s->inquery_title) != '') @php $p_name = $s->inquery_title @endphp @endif @if($s->home_inquiry && $s->home_inquiry->images != '' && $s->home_inquiry->show == 1 && file_exists('bdtdc-product-image/home-page/'.$s->home_inquiry->images))
<img itemprop="image" title="{{ $p_name }}" style="width:100%;height:229px;border:0;box-shadow:none" alt="{{ $p_name }}" class="img-thumbnail lazyload" data-original="{{ asset('assets/frontend/images/products/'.$s->home_inquiry->images) }}"> @else @if($s->inq_products_images)
...
<img itemprop="image" title="{{ $p_name }}" style="width:100%;height:229px;border:0;box-shadow:none" alt="{{ $p_name }}" class="img-thumbnail lazyload" data-original="{{ asset('assets/frontend/images/buying-request/'.$s->inq_docs_one->docs) }}"> @else
<img itemprop="image" title="{{ $p_name }}" style="width:100%;height:229px;border:0;box-shadow:none" alt="{{ $p_name }}" class="img-thumbnail lazyload" data-original="{{ asset('assets/frontend/images/no_image.jpg') }}"> @endif @endif
<p>
<span itemprop="name">{{substr($p_name,0,30)}}</span>
</p>
...
<img title="{{ $s->sender_company->country->name }}" itemprop="image" style="height:18px;width:25px" class="lazyload" data-original="{{ asset('assets/frontend/images/flags/'.strtolower($s->sender_company->country->iso_code_2).'.png') }}" alt="{{ $s->sender_company->country->name }}"> @else
<img itemprop="image" style="height:18px;width:25px" class="lazyload" data-original="{{ asset('assets/frontend/images/no-image.jpg') }}" alt="image"> @endif @else
<img itemprop="image" style="height:18px;width:25px" class="lazyload" data-original="{{ asset('assets/frontend/images/no-image.jpg') }}" alt="image"> @endif
</div>
...
<span class="supplier-type">Verified Suppliers</span>
<div style="padding-bottom:15px" style="text-align:center;margin-left:auto; margin-right:auto" class="summary hidden-xs hidden-s">
from India <span> <img class="flg-circle lazyload" itemprop="image" data-original="{{ asset('assets/frontend/images/flags/in.png') }}" /></span>
</div>
<div class="product-image-wrapper coun-wrp">
<div class="single-products">
<div class="productinfo text-center">
...
<span class="supplier-type">Verified Suppliers</span>
<div style="padding-bottom:15px" style="text-align:center;margin-left:auto; margin-right:auto" class="summary hidden-xs hidden-s">
from China <span> <img class="flg-circle lazyload" itemprop="image" data-original="{{ asset('assets/frontend/images/flags/cn.png') }}" /></span>
</div>
<div class="product-image-wrapper coun-wrp">
<div class="single-products">
<div class="productinfo text-center">
<img itemprop="image" style="width:100%;height:100%;border:0;box-shadow:none" class="lazyload" data-original="{{ asset('/assets/frontend/images/girl.jpg') }}" alt="" class="img-thumbnail ">
</div>
</div>
</div>
</a>
...
<div class="single-products">
<div class="productinfo text-center">
<img itemprop="image" style="width:100%;height:100%;border:0;box-shadow:none" class="lazyload" data-original="{{ asset('assets/frontend/images/TB1lY06LpXXXXXyXVXXXXXXXXXX-225-260.jpg') }}" alt="" class="img-thumbnail ">
</div>
</div>
</div>
</a>
...
@foreach($country as $data)
<li>
<a target="_blank" itemprop="url" rel="nofollow" href="{{ URL::to('recommended-suppliers/products/'.$data->name.'='.mt_rand(100000000, 999999999).$data->id,null)}}" datadata--src="{{ asset('assets/frontend/images/us.png')}}" style="background-image:url()"><img itemprop="image" style="width:42px;height:26px" class="lazyload" data-original="{{ asset('assets/frontend/images/flags/'.strtolower($data->iso_code_2).'.png')}}" alt="{{ $data->name }}" alt="{{ $data->name }}" /> {{ $data->name }}</a>
</li>
@endforeach
</ul>
</div>
...
<img class="lazyload" data-original="{{asset('assets/frontend/images/Buyer-protection-home.png')}}">
</div>
...
<img class="lazyload" data-original="{!! asset('assets/frontend/images/sprite.png') !!}" alt="">
</div>
...
<img style="width:100%;display:block;float:left;margin:0;padding:0;cursor:pointer" class="img-responsive play_video" src="{{ asset('assets/frontend/images/youtube-1.jpg') }}" alt="bdtdc news" />
</div>
...
<script type='text/javascript' src='{!! asset('assets/frontend/js/jquery.elastislide.js ') !!}'></script>
<script type='text/javascript' src='{!! asset('assets/frontend/js/vanilla-slider.js ') !!}'></script>
<script type='text/javascript' src='{!! asset('assets/frontend/js/jssor.slider.mini.js ') !!}'></script>
<script type="text/javascript" src="{!! asset('assets/frontend/js/jquery.bxslider.min.js') !!}"></script>
<script src="{{URL::asset('assets/frontend/js/animatedModal.min.js')}}"></script>
