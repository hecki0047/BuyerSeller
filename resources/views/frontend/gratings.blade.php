<div class="row" style="padding: 0; margin: 0;">
     <div class="col-sm-12 col-md-12 col-lg-12">
     		<div class="col-md-12 no-padding" style="background-color: #dff0d8; min-height: 240px;">
	    		...
	    		<div style="width: 70px; float: left;display: block; margin-top: 14px ;padding-left: 16px;">
	    				<img class="suc-img" src="{!! asset('assets/frontend/images/product-images/success.1.png',is_secured()) !!}" alt="sucess">
	    		</div>
	           ...
	           <div class="col-sm-3">
	              <div class="home-page" style="padding-left: 0; float: right;padding-top: 30px;">
	                        		<h4 style="margin-top: 0;"><a href="{{ URL::to('/',null,is_secured())}}">Back to Home Page <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></h4>
	                        </div>
	             </div>
	    </div>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12" style="    padding: 30px 0 30px 3%;">
    		<div class="col-sm-3 col-md-3 col-lg-3 " style="padding-left: 0;">
    		  <span style="margin-right: 8px;"><img src="{{asset('assets/frontend/images/Convenient.png')}}" alt="Convenient"></span><span>Convenient</span>
	...
	<div class="col-sm-12 col-md-12 col-lg-12 padding_0" style="border:1px solid #ddd; border-right:0 none;">
						...
						<div>
									<div style="padding-left: 30px; display: block;width: 100%; min-height: 45px; padding-top: 18px;"><span><img style="height: 25px; width: 25px; float: left;margin-right: 10px;" src="{{asset('assets/gold/customer-service.png')}}"></span><div style="text-align: left;font-size: 13px; font-weight: 600;">We are here to help!
									 ...
									 <div class="contg">
									 			...
									 			<div><a style="line-height: 20px;" href="{{URL::to('ServiceChannel/pages/for_buyer',35,is_secured())}}">Help Center</a> </div>
									 			 <div><a style="line-height: 20px;" href="{{URL::to('contact',null,is_secured())}}"> Contact Us</a></div>
									 			<!-- <div><a href="{{URL::to('ServiceChannel/pages/submit_a_dispute,39',is_secured())}}">Submit a Complaint </div> -->
									 			<div><a style="line-height: 20px;" href="{{URL::to('get-quotations',null,is_secured())}}">Submit Buying Request	</a> </div>
									 		</div>
		...
		<div class="col-sm-3 col-md-3 col-lg-3 cong-sce" style="border-right: 1px solid #ddd;">
								<div> <a href="{{URL::to('BuyerChannel/pages/trade_assurance',5,is_secured())}}">
		...
		<div class="col-sm-3 col-md-3 col-lg-3 cong-sce" style="border-right: 1px solid #ddd;">
					<div>
					<a href="{{URL::to('SupplierChannel/pages/suppliers_memebership/23',is_secured())}}">
