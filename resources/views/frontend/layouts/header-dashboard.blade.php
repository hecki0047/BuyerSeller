...
<a style="margin-left:0;background-image:none;height:auto;display:block;width:100%" rel="home" itemprop="url" title="Manufacturers-Suppliers" href="{{ URL::to('/',null,is_secured())}}">
...
<li><a style="padding-left:0" itemprop="url" href="{{ URL::to('online-marketplace',null,is_secured())}}">Shop by Category</a></li>
...
<li><a itemprop="url" href="{{ URL::to($page->prefix.'/pages/'.$page->sort_name,$page->id,is_secured())}}" class="prefix_url">{{ $page->name }}</a></li>
@endif
@endforeach
</ul>
</li>
...
<li><a target="_blank" itemprop="url" href="{{ URL::to($page->slug,null,is_secured())}}" class="prefix_url">{{ $page->name }}</a></li>
@endif
@endforeach
</ul>
</li>
<li><a style="margin-right:-1%" target="_blank" class="pull-right" href="{{ URL::to('about-us',null, is_secured())}}">About BuyerSeller</a></li>
</ul>
</div>
</div>
@if (Sentinel::check())
...
<form class="form form-horizontal" itemprop="target" action="{!!URL::to('search-product',null,is_secured())!!}" method="post">
...
<a itemprop="url" title="get quote" href="{{URL::to('get-quotations',null,is_secured())}}"><span style=""><img itemprop="image" style="padding-left:7%;padding-right:5px;margin-top:-8px;height:52px" class="img-responsive" src="{!! asset('assets/gold/Get-Quotation-dash.png',is_secured()) !!}" alt="Get Quotation home" /></span></a>
</div>
</div>
</div>
</div>
...
@if (Sentinel::check())
<li><a itemprop="url" href="{{ URL::to($dashboard_route,null,is_secured())}}">Dashboard</a></li>
@endif
<li title="" class="pusher_notification_1"><a itemprop="url" href="{{ URL::to('default/message?inq_sub_menu=New Inquiries',null,is_secured()) }}">New Inquiry <span style="margin-left:5px"><i data-count="{{$inquiry_notifications}}" class="glyphicon notification-icon"></i></span>
</a>
</li>
<li title="" class="pusher_notification_2"><a itemprop="url" href="{{ URL::to('Mybuying-Request?status=0&unread=true&search=&d=0',null,is_secured()) }}">New Quote <span style="margin-left:5px"><i data-count="{{$quote_notifications}}" class="glyphicon notification-icon"></i></span>
</a>
</li>
<li style="margin-left:0" class="pusher_notification_3"><a itemprop="url" href="{{ URL::to('order-list',null,is_secured()) }}" class="join_btn"><i class="fa fa-users" aria-hidden="true"></i> Order <span style="margin-left:5px"><i data-count="{{$order_notifications}}" class="glyphicon notification-icon"></i></span>
</a>
</li>
...
<li class="navigation-menu-list-li"><a itemprop="url" href="{{ URL::to('Mybuying-Request',null,is_secured()) }}" class="navigation-menu-list-li-a">Manage Buying Requests</a></li>
<li style="margin-bottom:10px" class="navigation-menu-list-li"><a itemprop="url" href="{{ URL::to('list/view/requested/sample',null,is_secured()) }}" class="navigation-menu-list-li-a">Manage Sample Requests</a></li>
@if($role->role_id ==3)
...
<li class="navigation-menu-list-li"><a itemprop="url" target="_blank" href="{{ URL::to('dashboard','product',is_secured()) }}" class="navigation-menu-list-li-a">Display New Products</a></li>
<li class="navigation-menu-list-li"><a itemprop="url" target="_blank" href="{{ URL::to('dashboard','company_site',is_secured()) }}" class="navigation-menu-list-li-a">Company & Site</a></li>
<li class="navigation-menu-list-li"><a itemprop="url" target="_blank" href="{{ URL::to('quotation/management',null,is_secured()) }}" class="navigation-menu-list-li-a">Quotes Management</a></li>
@endif
@if (Sentinel::check())
<li style="margin-left:0;padding:0;border-left:1px solid #cecece;height:12px;top:8px"></li>
<li style="background-color:#fff;border-top:1px solid #ddd;list-style:none outside none;padding-top:5px;line-height:22px;color:#333;font-weight:700;white-space:nowrap;box-shadow:none"><a style="background-color:#fff;list-style:none outside none;padding-top:5px;line-height:22px;color:#333;font-weight:700;white-space:nowrap;box-shadow:none" class="btn" href="{{ URL::to('logout',null,is_secured()) }}"> Logout </a> </li>
@endif
@else
<li style=""><a itemprop="url" href="{{ URL::to('login',null,is_secured()) }}" class="" data-toggle="">Sign In</a></li>
<li style="margin-left:0;padding:0;border-left:1px solid #cecece;height:12px;top:8px"></li>
<li style="margin-left:0"><a itemprop="url" href="{{ URL::to('join',null,is_secured()) }}" class="join_btn">Join Free</a></li>
@endif
</ul>
</li>
</ul>
