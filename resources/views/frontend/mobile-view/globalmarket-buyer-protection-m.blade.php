...
<div class="row padding_0" style="background-color: #fff; margin-bottom: 28px; padding-bottom: 28px;border-bottom:1px solid rgba(0,0,0,.1)">
					...
					<ul class="step-ul" style="padding-top: 4%;padding-left: 3%;">
			 			<li class="step-ul-li" style="background: #F2F2F2; margin-bottom: 15px;width: 28%;height: 178px;">
				 			<div style="width: 100%; display: block;padding: 0;margin: 0;">
				 				<img class="img-responsive" itemprop="image"  src="{!! asset('assets/fontend/bdtdc-images/Buyer-Places-Order.png',is_secured()) !!}" alt="buyer places order">
				 			</div>
				 		</li>
				 		<li class="step-ul-li" style="background: #EFF6FE;margin-bottom: 15px;width: 28%;height: 178px;">
				 			<div style="width: 100%; display: block;padding: 0;margin: 0;">
				 				<img itemprop="image" class="img-responsive"  src="{!! asset('assets/fontend/bdtdc-images/Buyer-pays-to-Bdtdc.png',is_secured()) !!}" alt="buyer pays to bdtdc">
				 			</div>
				 		</li>
				 		<li class="step-ul-li" style="background: #F2F2F2;margin-bottom: 15px;width: 28%;height: 178px;">
				 			<div style="width: 100%; display: block;padding: 0;margin: 0;">
				 				<img itemprop="image" class="img-responsive"  src="{!! asset('assets/fontend/bdtdc-images/Bdtdc-Pays-to-Manufacturer.png',is_secured()) !!}" alt="manufacturer fulfill order">
				 			</div>
				 		</li>
				 		<li class="step-ul-li" style="background: #F2F2F2;margin-bottom: 15px;width: 28%;height: 178px;">
				 			<div style="width: 100%; display: block;padding: 0;margin: 0;">
				 				<img itemprop="image" class="img-responsive"  src="{!! asset('assets/fontend/bdtdc-images/Buyer-Receives-Order.png',is_secured()) !!}" alt="buyer receives order">
			 				</div>
				 		</li>
				 		<li class="step-ul-li" style="background: #EFF6FE;margin-bottom: 15px;width: 28%;height: 178px;">
				 			<div style="width: 100%; display: block;padding: 0;margin: 0;">
				 				<img itemprop="image" class="img-responsive"  src="{!! asset('assets/fontend/bdtdc-images/Manufacturer-Fulfill-Order.png',is_secured()) !!}" alt="Bdtdc Pays to Manufacturer">
				 			</div>
				 		</li>
					</ul>
				...
				<div>
				<div class="col-sm-12 col-md-12 col-lg-12">
					 <p class="payment"><img itemprop="image" style="margin: 0;"  src="{!! asset('assets/fontend/bdtdc-images/buyer -affirms-order.png',is_secured()) !!}" alt="confirms order"><span style="background: #EFF6FE;padding: 12px 20px;  line-height:35px; margin-left: 10px;">Bdtdc.com holds payment until buyer affirms order</span></p>
					</div>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12">
...
received.</p>
				...
				<div class="col-sm-12 col-md-12 col-lg-12" style="    border-bottom: 1px solid #ccc;">
						<div class="col-sm-2 col-md-1 col-lg-1">
							<img itemprop="image" class="step-img" style="padding-left: 4%;"  src="{!! asset('assets/fontend/bdtdc-images/Payment.png',is_secured()) !!}" alt="Payment">
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="button-line"><a itemprop="url"  href="{{URL::to('biz-bdtdc/order-protect',null,is_secured())}}" class="large-button22 " target="_blank" style="border-radius: 5px !important;">Order with Buyer Protection</a></div>
	</div>
</div>
