...
@section('page_css')
<link property='stylesheet' href="{!! asset('assets/frontend/css/bangladesh-suppliers.css',is_secured()) !!}" rel="stylesheet">
<link property='stylesheet' href="{!! asset('assets/frontend/css/custom.min.css',is_secured()) !!}" rel="stylesheet">
{{-- <link property='stylesheet' rel="stylesheet" type="text/css" href="{{ URL::asset('assets/fontend/css/animate.css',is_secured()) }}" media="screen" data-name="skins"> --}}
{{-- <link property='stylesheet' href="{!! asset('assets/fontend/topbar/css/animate.min.css',is_secured()) !!}" media="all" rel="stylesheet" type="text/css" /> --}}
...
@include('frontend.layouts.search_result_aside')
<div class="col-sm-9 col-md-10 col-xs-12 padding_0" style="border-left: 1px solid #ddd;padding-top: 10px">
   <p style="padding-left: 28px">Related Searches for Bangladesh Suppliers: <a itemprop="url" target="_blank" href="{{URL::to('selected-suppliers/bangladesh-products/18',is_secured())}}">Bangladesh Products</a></p>
   <div class="col-sm-12 col-md-12 col-xs-12 padding-right" style="padding-bottom: 0.5%">
      <form action="{{ URL::to('others_filter',null,is_secured()) }}" class="form others_filter_form" method="post">
         ...
         <div class="col-sm-8 col-md-8 col-xs-12" style="padding-top:0px;text-align: right;">
            ...
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               ...
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/gold/Buyer-protection-home.png',is_secured()) !!}" alt="Buyer Protection">Buyer Protection</span>
            </label>
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               ...
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/helpcenter/Gold-membership.png',is_secured()) !!}" alt="Gold Supplier">Gold Supplier</span>
            </label>
            <!-- </a> -->
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               ...
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/helpcenter/verified-supplier.png',is_secured()) !!}" alt="Assessed Supplier">Assessed Supplier</span>
            </label>
         </div>
      </form>
   </div>
         ...
         <div class="list_product col-xs-12" style=" border-bottom: 1px solid #ddd; margin-bottom: 1% ">
            <div class="col-sm-12 padding_0">
               <div class="col-sm-9 padding_0">
                  ...
                  @if($s->is_gold==1)
                  @if($s->is_gold==1)
                  <img style="height: 25px;width: 25px;float:left;" src="{{ asset('assets/gold/Gold-membership.jpg',is_secured())}}" alt="Gold Supplier" />

                  @else
                  <img style="height: 25px;width: 25px; float:left;" src="{{ asset('assets/gold/bdtdc-free.jpg',is_secured())}}" alt="free membership" />
                  @endif
                  @else
                  <img style="height: 25px;width: 25px;float:left;" src="{{ asset('assets/gold/bdtdc-free.jpg',is_secured())}}" alt="free membership" />
                  @endif
                  ...
                  <p class="comp_title">
                     ...
                     <a itemprop="url" target="_blank" href="{{ URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$s->name_string->name),$s->id,is_secured()) }}"><?php if($s->users){echo $s->users->first_name;}else{echo "name not available";} ?> - <?php if($s->name_string){echo $s->name_string->name;}else{echo "name not available";} ?></a>
               ...
               <div class="col-xs-12 col-md-12 col-sm-12 padding_0">
                  <div style="padding-bottom:10px; padding-left:15px;" class="col-xs-6 col-md-4 col-sm-4 padding_0">
                     @if(isset($s->name_string))
                     <a itemprop="url" href="{{ URL::to('contact/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$s->name_string->name),$s->id,is_secured()) }}" data-id="{{ $s->user_id }}">
                  ...
                  <a itemprop="url" target="_blank" class="" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-', $p->pro_to_cat_name->name).'='.mt_rand(100000000, 999999999).$p->product_id) }}" style="display: block;">
                     <div class="single-products">
                        ...
                        <div class="productinfo text-center">
                           <?php
									$img_url = URL::to('uploads/no_image.jpg',is_secured());
									if($p->pro_images_new){
										if($p->pro_parent_cat && $p->bdtdcCategory){
											$img_url = URL::to('bdtdc-product-image/'.trim($p->pro_parent_cat->name).'/'.trim($p->bdtdcCategory->name).'/'.$p->pro_images_new->image,null,is_secured());
										}else{
											$img_url = URL::to('uploads/no_image.jpg',null,is_secured());
										}
									}else if($p->pro_images){
										$img_url = URL::to('uploads/'.$p->pro_images->image,null,is_secured());
									}
									?>
                           @if($p->pro_images_new)

                           <img title="{{ $p->pro_to_cat_name->name ?? '' }}" style="height:120px;width:250px" class="img-thumbnail" src="{{ asset(''.$p->pro_images_new->image,is_secured()) }}" alt="{{ $p->pro_to_cat_name->name ?? '' }}" />
                           ...
                           <!-- <a itemprop="url"  target="_blank" class="pro_name" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-', $p->pro_to_cat_name->name).'='.mt_rand(100000000, 999999999).$p->product_id,is_secured()) }}" style="display: block; font-size: 12px;line-height: 13px;margin-top:0%">{{ substr($p->pro_to_cat_name->name,0,25) }}...</a> -->
                        </div>
            ...
            <div class="col-xs-7 col-md-2 col-sm-4 padding_0">
               <div class="product-image-wrapper">
                  <a itemprop="url" target="_blank" class="" href="#" style="display: block;">
                     <div class="single-products">
                        <div class="productinfo text-center">
                           <img title="" style="width:100%;height:120px;margin-left:0" src="{{ asset('uploads/no_image.jpg',is_secured())}}" class="img-responsive" alt="Bangladeshi Suppliers">
